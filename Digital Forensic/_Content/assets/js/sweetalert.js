! function (e, t) {
    ...
    var e = {
        ...
        U = function (t) {
            ...
            r = i && a && i.parentNode !== a.parentNode ? l(t) : i || l(t);
            for (var s in t) e.hasOwnProperty(s) || "extraParams" === s || console.warn('SweetAlert2: Unknown parameter "' + s + '"');
            r.style.width = "number" == typeof t.width ? t.width + "px" : t.width, r.style.padding = t.padding + "px", r.style.background = t.background;
            for (var u = r.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), p = 0; p < u.length; p++) u[p].style.background = t.background;
            var y = f(),
                k = m(),
                S = g(),
                x = b(),
                A = w(),
                q = C();
            if (t.titleText ? y.innerText = t.titleText : y.innerHTML = t.title.split("\n").join("<br />"), t.text || t.html) {
                if ("object" === R(t.html))
                    if (k.innerHTML = "", 0 in t.html)
                        for (var V = 0; V in t.html; V++) k.appendChild(t.html[V].cloneNode(!0));
                    else k.appendChild(t.html.cloneNode(!0));
                else t.html ? k.innerHTML = t.html : t.text && (k.textContent = t.text);
                P(k)
            } else T(k);
            t.showCloseButton ? P(q) : T(q), r.className = n.modal, t.customClass && E(r, t.customClass);
            var O = h(),
                H = parseInt(null === t.currentProgressStep ? $.getQueueStep() : t.currentProgressStep, 10);
            t.progressSteps.length ? (P(O), L(O), H >= t.progressSteps.length && console.warn("SweetAlert2: Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), t.progressSteps.forEach(function (e, o) {
                var r = document.createElement("li");
                if (E(r, n.progresscircle), r.innerHTML = e, o === H && E(r, n.activeprogressstep), O.appendChild(r), o !== t.progressSteps.length - 1) {
                    var i = document.createElement("li");
                    E(i, n.progressline), i.style.width = t.progressStepsDistance, O.appendChild(i)
                }
            })) : T(O);
            for (var N = d(), j = 0; j < N.length; j++) T(N[j]);
            if (t.type) {
                var I = !1;
                for (var K in o)
                    if (t.type === K) {
                ...
                if (!I) return console.error("SweetAlert2: Unknown alert type: " + t.type), !1;
                var D = r.querySelector("." + n.icon + "." + o[t.type]);
                if (P(D), t.animation) switch (t.type) {
                    case "success":
                        E(D, "swal2-animate-success-icon"), E(D.querySelector(".swal2-success-line-tip"), "swal2-animate-success-line-tip"), E(D.querySelector(".swal2-success-line-long"), "swal2-animate-success-line-long");
                        break;
                    case "error":
                        E(D, "swal2-animate-error-icon"), E(D.querySelector(".swal2-x-mark"), "swal2-animate-x-mark")
                }
            }
            var W = v();
            t.imageUrl ? (W.setAttribute("src", t.imageUrl), P(W), t.imageWidth ? W.setAttribute("width", t.imageWidth) : W.removeAttribute("width"), t.imageHeight ? W.setAttribute("height", t.imageHeight) : W.removeAttribute("height"), W.className = n.image, t.imageClass && E(W, t.imageClass)) : T(W), t.showCancelButton ? A.style.display = "inline-block" : T(A), t.showConfirmButton ? M(x, "display") : T(x), t.showConfirmButton || t.showCancelButton ? P(S) : T(S), x.innerHTML = t.confirmButtonText, A.innerHTML = t.cancelButtonText, t.buttonsStyling && (x.style.backgroundColor = t.confirmButtonColor, A.style.backgroundColor = t.cancelButtonColor), x.className = n.confirm, E(x, t.confirmButtonClass), A.className = n.cancel, E(A, t.cancelButtonClass), t.buttonsStyling ? (E(x, n.styled), E(A, n.styled)) : (B(x, n.styled), B(A, n.styled), x.style.backgroundColor = x.style.borderLeftColor = x.style.borderRightColor = "", A.style.backgroundColor = A.style.borderLeftColor = A.style.borderRightColor = ""), !0 === t.animation ? B(r, n.noanimation) : E(r, n.noanimation)
        },
        z = function (e, t) {
            var o = u(),
                r = c();
            e ? (E(r, n.show), E(o, n.fade), B(r, n.hide)) : B(r, n.fade), P(r), o.style.overflowY = "hidden", O && !S(r, n.noanimation) ? r.addEventListener(O, function e() {
        ...
        Y = function () {
            if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && !S(document.body, n.iosfix)) {
        ...
        $ = function e() {
            ...
            return new Promise(function (t, o) {
                            ...
                            if (c && e.isVisible())
                                if (e.disableButtons(), l.input) {
                                    ...
                                    l.inputValidator ? (e.disableInput(), l.inputValidator(f, l.extraParams).then(function () {
                                        e.enableButtons(), e.enableInput(), S(f)
                }, function (t) {
                ...
                }, M = d.querySelectorAll("button"), O = 0; O < M.length; O++) M[O].onclick = L, M[O].onmouseover = L, M[O].onmouseout = L, M[O].onmousedown = L;
                C().onclick = function () {
                ...
                window.onkeydown && window.onkeydown.toString() === D.toString() || (a.previousWindowKeyDown = window.onkeydown, window.onkeydown = D), l.buttonsStyling && (N.style.borderLeftColor = l.confirmButtonColor, N.style.borderRightColor = l.confirmButtonColor), e.hideLoading = e.disableLoading = function () {
                    l.showConfirmButton || (T(N), l.showCancelButton || T(g())), B(H, n.loading), B(d, n.loading), N.disabled = !1, I.disabled = !1
                }, e.getTitle = function () {
                    return f()
    ...
    return $.isVisible = function () {
        ...
        if (o) {
            ...
            O && !S(o, n.noanimation) ? o.addEventListener(O, function e() {
                o.removeEventListener(O, e), S(o, n.hide) && r()
        ...
        if (!e || "object" !== (void 0 === e ? "undefined" : R(e))) return console.error("SweetAlert2: the argument for setDefaults() is required and has to be a object");
        for (var t in e) $.isValidParameter(t) || (console.warn('SweetAlert2: Unknown parameter "' + t + '"'), delete e[t]);
        I(K, e)
    }, $.resetDefaults = function () {
        K = I({}, e)
    }, $.noop = function () { }, $.version = "6.6.8", $.default = $, $
